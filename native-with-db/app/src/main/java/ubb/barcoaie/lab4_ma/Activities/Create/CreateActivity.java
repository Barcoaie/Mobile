package ubb.barcoaie.lab4_ma.Activities.Create;
...
import ubb.barcoaie.lab4_ma.Repository.VegetableDatabase;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        create_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Vegetable vegetable = new Vegetable(vegetable_name.getText().toString(), Integer.parseInt(vegetable_price.getText().toString()));
